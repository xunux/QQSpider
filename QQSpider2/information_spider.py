...
class InformationSpider(object):
    ...
    def beginer(self):
        ...
        while failure < self.message.fail_time:
            ...
            try:
                ...
                if not (result2 and result3):  # 如果个人信息或者空间信息获取失败
                    return {}
    ...
    def get_personal_information(self, information):
        """ 获取个人信息 """
        url = "https://h5.qzone.qq.com/proxy/domain/base.qzone.qq.com/cgi-bin/user/cgi_userinfo_get_all?uin=%s&vuin=%s&fupdate=1&g_tk=%s" % (
        ...
        try:
            ...
            information["Birthday"] = datetime.datetime.strptime(str_birthday, "%Y-%m-%d") - datetime.timedelta(hours=8)
        except Exception:
            information["Birthday"] = datetime.datetime.strptime("1700-01-01", "%Y-%m-%d") - datetime.timedelta(hours=8)
        try:
    ...
    def get_qzone_information1(self, information):
        ...
        try:
            ...
            information["PageView"] = int(pageView[0])
        except Exception:
